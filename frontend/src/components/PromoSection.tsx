...
function calcDiscountPercent(price: number, discountedPrice: number): string {
...
function PromoCard({ product }: { product: Product }) {
  ...
  const discountLabel = calcDiscountPercent(product.price, product.discountedPrice!);
