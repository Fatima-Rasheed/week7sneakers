      ...
      >
        ...
        {product.image?.url && (
          <Box
            ...
            sx={{
              position: 'absolute',
              // Positioned to the right and overlapping the top
              top: 60,
              right: { xs: -12, md: -42 },
              width: { xs: '190px', md: '350px' },
              height: 'auto',
              objectFit: 'contain',
              // Custom drop shadow to match the floating look
              filter: 'drop-shadow(0px 20px 30px rgba(0,0,0,0.25))',
              zIndex: 10,
              // The signature Nike promo tilt
  ...
  return (
    <Box sx={{ width: '100%', pb: { xs: 4, md: 15 } }}>
      ...
      <Box sx={{ position: 'relative', width: '100%' }}>
        ...
        <Box
          sx={{
            // Desktop: absolute overlap over the banner bottom
            position: { xs: 'static', md: 'absolute' },
            bottom: { md: -110 },
            left: { md: 0 },
            right: { md: 0 },
            // Mobile: pull it up slightly so it sits snug under the banner
            mt: { xs: -4, md: 0 },
            display: 'flex',
